...
public class Test_split_02 {
	public static void main(String[] args) {
		...
		State state_l00=StateSet.get(0);
		
		ArrayList<State> newStates=SplitSuseSs.splitSuseSs(state_l00, StateSet, TransitionSet, ClockSet);//l0被拆分成新的状态集合
