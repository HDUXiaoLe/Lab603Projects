...
public class Test_split_04 {
	public static void main(String[] args) {
		...
		State state_l1=StateSet.get(2);
		
		ArrayList<State> newStates=SplitSuseSs.splitSuseSs(state_l1, StateSet, TransitionSet, ClockSet);//l0被拆分成新的状态集合
