...
public class Test_split_03_new {
	...
	public static ArrayList<State> newState(){
		...
		ArrayList<State> StateSet=Test_split_02_new.getPs();//这里的状态集合是l0被拆分后的新的状态集合
		...
		ArrayList<State> newStates=SplitSuseSs_new1.splitSuseSs(l1, StateSet, TransitionSet, ClockSet);//l00被拆分成新的状态集合
