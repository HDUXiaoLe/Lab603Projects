 ...
 * 
 */
@ManagedBean(registeredManually=true)//手动注入Bean
public class DialogFactory
{
    ...
    public DialogFactory(DialogFactoryMode factoryMode)
    {
        ...
        //这个类可以注入外部值对象的属性。为此,它使用ResourceBundleBean注释。注射使用ResourceFactory创建的对象
    ...
    
    {
        ...
        //如果工厂配置是一种对话框DELEGATED_MODE,而且还没有一个侦听器侦听并显示对话框,对话框都加入一种缓存。然后侦听器登记,所有缓存发送对话框显示。 
    }
