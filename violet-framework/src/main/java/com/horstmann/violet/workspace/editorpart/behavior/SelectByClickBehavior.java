...
public class SelectByClickBehavior extends AbstractEditorPartBehavior
{
    ...
    private void processSelectionInConflictWithDraggingEvents(boolean isResetSelectionFirst) {
        ...
        if (isResetSelectionFirst) {
            ...
            if (this.unprocessedLine != null) {
                this.selectionHandler.addSelectedElement(this.unprocessedLine);
            }
        }
        ...
        if (!isResetSelectionFirst) {
            ...
            if (this.unprocessedLine != null) {
                this.selectionHandler.removeElementFromSelection(this.unprocessedLine);
            }
        }
    }
    ...
    private IHorizontalChild unprocessedLine = null;
