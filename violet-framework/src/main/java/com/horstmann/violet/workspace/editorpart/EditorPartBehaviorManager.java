...
public class EditorPartBehaviorManager implements IEditorPartBehaviorManager
{
    ...
    {
        for (IEditorPartBehavior aBehavior : this.behaviors)
            aBehavior.whileEditingHorizontalChild(edge, event);
    }

    @Override
    public void fireAfterEditingHorizontalChild(IHorizontalChild edge)
    {
        for (IEditorPartBehavior aBehavior : this.behaviors)
            aBehavior.afterEditingHorizontalChild(edge);
    }
    ...
    @Override
    public void fireOnHorizontalChildSelected(IHorizontalChild edge)
    {
        for (IEditorPartBehavior aBehavior : this.behaviors)
	...
	@Override
	public void fireBeforeChangingStateline(INode n) {
		// TODO Auto-generated method stub
		 for (IEditorPartBehavior aBehavior : this.behaviors)
	            aBehavior.beforeChangingStateline(n);
	}

	@Override
	public void fireAfterChangingStateline(INode n) {
		// TODO Auto-generated method stub
		 for (IEditorPartBehavior aBehavior : this.behaviors)
	            aBehavior.afterChangingStateline(n);
	}
    @Override
    public void fireAfterChangingStatelineTwo(INode n)
    {
