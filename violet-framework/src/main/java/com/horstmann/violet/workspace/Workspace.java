...
import com.horstmann.violet.workspace.editorpart.behavior.TimingChangeStateBehavior;
import com.horstmann.violet.workspace.editorpart.behavior.TimmingDiagramStateLineChange;
...
public class Workspace implements IWorkspace
{
    ...
    public IEditorPart getEditorPart()
    {
        if (this.graphEditor == null)
        {
            ...
            behaviorManager.addBehavior(new ResizeElement(this.graphEditor,this.getSideBar().getGraphToolsBar()));
            behaviorManager.addBehavior(new TimmingDiagramStateLineChange(this.graphEditor,this.getSideBar().getGraphToolsBar()));
