...
public class GraphTool
{
     ...
     * @param label
     */
    public GraphTool(final IEdge e, String label)//参数一个是边，一个是String类型的标签
    {
        this.nodeOrEdge = e;//设置一个对象为边类型
        this.label = label;
        this.icon = new Icon()
        {
...
//画指定的图标
    ...
    private static final int ICON_SIZE = 30;//private static final int ICON_SIZE=20;
