...
public interface IEditorPartBehaviorManager
{
    ...
    public abstract void fireBeforeEditingHorizontalChild(IHorizontalChild edge);
    
    public abstract void fireWhileEditingHorizontalChild(IHorizontalChild  edge, PropertyChangeEvent event);
    
    public abstract void fireAfterEditingHorizontalChild(IHorizontalChild  edge);
    ...
    public abstract void fireAfterChangingStateline(INode n);
    
    public abstract void fireOnHorizontalChildSelected(IHorizontalChild  edge);
	...
	public abstract void fireAfterChangingStatelineTwo(INode n);
